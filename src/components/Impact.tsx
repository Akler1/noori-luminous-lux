...
export const Impact = () => {
  ...
  return (
    <section id="impact" className="py-20 bg-secondary text-foreground">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center reveal-up">
            ...
            <Button 
              variant="outline" 
              className="bg-transparent border-accent/30 text-foreground hover:bg-accent hover:text-background group"
            >
